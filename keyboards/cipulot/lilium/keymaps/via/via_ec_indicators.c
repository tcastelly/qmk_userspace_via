...
enum via_enums {
    ...
    id_layers_indicator_enabled = 4,
    id_actuation_mode = 5,
    id_mode_0_actuation_threshold = 6,
    id_mode_0_release_threshold = 7,
    id_save_threshold_data = 8,
    id_mode_1_initial_deadzone_offset = 9,
    id_mode_1_actuation_offset = 10,
    id_mode_1_release_offset = 11,
    id_bottoming_calibration = 12,
    id_noise_floor_calibration = 13,
    id_show_calibration_data = 14,
    id_clear_bottoming_calibration_data = 15
    // clang-format on
};
    ...
    switch (*value_id) {
        ...
        case id_layers_indicator_enabled: {
            if (value_data[0] == 1) {
                ...
                uprintf("###########################\n");
                uprintf("# Layer indicator enabled #\n");
                uprintf("###########################\n");
            } else {
                eeprom_ec_config.layer_indicator_enabled = false;
                uprintf("############################\n");
...
void via_config_get_value(uint8_t *data) {
    ...
    switch (*value_id) {
        ...
        case id_layers_indicator_enabled: {
            value_data[0] = eeprom_ec_config.layer_indicator_enabled;
            break;
        }
        case id_actuation_mode: {
