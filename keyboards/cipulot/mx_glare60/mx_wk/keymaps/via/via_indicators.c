    ...
    if (mode) { // set
        switch (field) {
            case 0: // mode/resolution
                ...
                eeprom_mx_wk_config.eeprom_socd_opposing_pairs[pair_idx].resolution = value;
                eeprom_mx_wk_config.eeprom_socd_opposing_pairs[pair_idx].held[0]    = false;
                eeprom_mx_wk_config.eeprom_socd_opposing_pairs[pair_idx].held[1]    = false;
                eeconfig_update_kb_datablock_field(eeprom_mx_wk_config, eeprom_socd_opposing_pairs);
                return 0;
            case 1: // key 1
                socd_opposing_pairs[pair_idx].keys[0]                              = value;
                socd_opposing_pairs[pair_idx].held[0]                              = false;
                socd_opposing_pairs[pair_idx].held[1]                              = false;
                eeprom_mx_wk_config.eeprom_socd_opposing_pairs[pair_idx].keys[0] = value;
                eeprom_mx_wk_config.eeprom_socd_opposing_pairs[pair_idx].held[0] = false;
                eeprom_mx_wk_config.eeprom_socd_opposing_pairs[pair_idx].held[1] = false;
                eeconfig_update_kb_datablock_field(eeprom_mx_wk_config, eeprom_socd_opposing_pairs);
                return 0;
            case 2: // key 2
                ...
                socd_opposing_pairs[pair_idx].held[0]                              = false;
                socd_opposing_pairs[pair_idx].held[1]                              = false;
                eeprom_mx_wk_config.eeprom_socd_opposing_pairs[pair_idx].keys[1] = value;
                eeprom_mx_wk_config.eeprom_socd_opposing_pairs[pair_idx].held[0] = false;
                eeprom_mx_wk_config.eeprom_socd_opposing_pairs[pair_idx].held[1] = false;
                eeconfig_update_kb_datablock_field(eeprom_mx_wk_config, eeprom_socd_opposing_pairs);
                return 0;
        ...
        switch (field) {
            case 0: // mode/resolution
                return eeprom_mx_wk_config.eeprom_socd_opposing_pairs[pair_idx].resolution;
            case 1: // key 1
                return eeprom_mx_wk_config.eeprom_socd_opposing_pairs[pair_idx].keys[0];
            case 2: // key 2
                return eeprom_mx_wk_config.eeprom_socd_opposing_pairs[pair_idx].keys[1];
            default:
                return 0;
        }
    }
