...
void eeconfig_init_kb(void) {
    ...
    eeprom_mx_wk_config.ind1.func    = 0x04;
    eeprom_mx_wk_config.ind1.index   = 0;
    eeprom_mx_wk_config.ind1.enabled = true;

    eeprom_mx_wk_config.ind2.h       = 86;
    eeprom_mx_wk_config.ind2.s       = 255;
    eeprom_mx_wk_config.ind2.v       = 150;
    eeprom_mx_wk_config.ind2.func    = 0x04;
