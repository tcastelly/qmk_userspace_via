...
} eeprom_mx_wkl_config_t;

// Compile-time check for EECONFIG_KB_DATA_SIZE
_Static_assert(sizeof(eeprom_mx_wkl_config_t) == EECONFIG_KB_DATA_SIZE, "Mismatch in keyboard EECONFIG stored data");

// Extern declarations
extern eeprom_mx_wkl_config_t eeprom_mx_wkl_config;
