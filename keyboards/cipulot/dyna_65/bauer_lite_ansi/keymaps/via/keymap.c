...
#include "keyboards/cipulot/dyna_65/bauer_lite_ansi/hybrid_switch_matrix.h"
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        ...
        KC_LCTL,  KC_A,     KC_S,     KC_D,  KC_F,    KC_G,  KC_H,    KC_J,  KC_K,  KC_L,     KC_SCLN,  KC_QUOT,            KC_ENTER,            KC_PGDN,
    ...
    [1] = LAYOUT(
        ...
        _______,            KC_MPRV,  KC_MNXT,  KC_MPLY,  _______,  _______,  _______,  KC_END,   KC_PGDN,  _______,  _______,  _______,            _______,  _______,
