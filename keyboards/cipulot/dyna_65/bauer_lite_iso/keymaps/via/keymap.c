...
#include "keyboards/cipulot/dyna_65/bauer_lite_iso/hybrid_switch_matrix.h"
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        ...
        KC_LCTL,  KC_A,     KC_S,     KC_D,  KC_F,    KC_G,  KC_H,    KC_J,  KC_K,  KC_L,     KC_SCLN,  KC_QUOT,  KC_NUHS,  KC_ENTER,            KC_PGDN,
        KC_LSFT,  KC_NUBS,  KC_Z,     KC_X,  KC_C,    KC_V,  KC_B,    KC_N,  KC_M,  KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,             KC_UP,    MO(1),
        KC_LGUI,  KC_LGUI,  KC_LALT,                         KC_SPC,                                              KC_RALT,  KC_LEFT,   KC_DOWN,  KC_RIGHT),
    ...
    [1] = LAYOUT(
        ...
        _______,  KC_VOLD,  KC_VOLU,  KC_MUTE,  _______,  _______,  _______,  _______,  KC_HOME,  KC_PGUP,  _______,  _______,  _______,  _______,            _______,
        _______,  _______,  KC_MPRV,  KC_MNXT,  KC_MPLY,  _______,  _______,  _______,  KC_END,   KC_PGDN,  _______,  _______,  _______,            _______,  _______,
